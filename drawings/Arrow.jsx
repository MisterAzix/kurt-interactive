...
export default function Arrow (props) {
    return (
        <Svg animate={{ x: [-10, 0] }} transition={{ repeat: Infinity, repeatType: "mirror", duration: 0.5 }} {...props} width="123" height="57"
             viewBox="0 0 123 57" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
